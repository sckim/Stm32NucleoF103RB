...
- HAL이 내부에서 하는 일을 직접 해 보며 `01`, `02`의 API가 무엇을 감싸는지 이해한다.
...
`01_BlinkHAL`, `02_BlinkLL`과 비교. SysTick을 더 자세히 다루는 `08_Clock_System/71_SysTick_Reg_c`, 비트 밴딩 `08_BitBanding_Reg_c`.
