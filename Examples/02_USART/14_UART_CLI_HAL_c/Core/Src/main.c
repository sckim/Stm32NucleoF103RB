/**
 * 14_UART_CLI_HAL_c  —  [계층: HAL]  UART 명령줄 인터페이스(CLI): 한 줄 입력 편집 + 명령어 테이블
 *
 ...
 *
 * 설계
 *   1) 수신: 인터럽트가 1바이트씩 링 버퍼(13번 예제와 같은 방식)에 넣는다.
 ...
 *     (진단 방법은 08_Clock_System/74_HardFault_Diagnosis 참고)
 *
 * ISR vs 콜백
