/**
 * 08_I2C_DS3231_RTC_HAL_c  —  [계층: HAL]  I2C 외장 RTC DS3231: BCD 시각 읽기/쓰기, 온도 센서, 컴파일 시각으로 설정
 *
 ...
 *
 * 참고: 같은 I2C 버스에 EEPROM(07_I2C_EEPROM_AT24C, ZS-042 는 0x57)이 함께 있을 수 있다 (02_I2C_Scan 으로 확인).
 * 인터럽트를 사용하지 않는다.
 */
#include "main.h"
#include <stdio.h>
