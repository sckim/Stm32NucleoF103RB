/**
 * 03_SPI_OLED_SSD1306_HAL_c  —  [계층: HAL]  SPI 로 SSD1306 128x64 OLED 구동 (7핀 SPI 모듈)
 *
 * 04_I2C_Communication/05_I2C_OLED_SSD1306 과 같은 화면(프레임버퍼, 선, 공, 프레임 번호/FPS)을 SPI 로 그린다. 통신 방식 차이가 핵심이다.
