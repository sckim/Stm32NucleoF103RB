...
`05_SPI_Communication/01_SPI_Loopback_HAL_c`, `07_DMA/01_DMA_MemToMem_HAL_c`, `10_Flash_CRC/02_CRC_Unit_HAL_c`(DWT로 시간 측정 활용), `03_NVIC_Priority_HAL_c`.
