...
한경국립대학교 전자공학전공 **임베디드시스템** 교과목의 실습 자료 저장소이다. STM32 Nucleo-F103RB(ARM Cortex-M3) 보드를 기준으로 GPIO부터 인터럽트, 타이머, ADC, UART, I2C까지 단계별 예제 프로젝트와 참고 문서, 회로 시뮬레이션 파일을 정리한다.
